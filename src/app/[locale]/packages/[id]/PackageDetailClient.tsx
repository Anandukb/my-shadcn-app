...
function buildSharedData(pkg: any) {
  const itineraryDays = [
    { day: 1, title: `Arrival in ${pkg.location}`, desc: "Welcome to your destination! Upon arrival, you'll be greeted by our representative and transferred to your hotel. Check-in and relax. Evening at leisure to explore the neighborhood.", highlights: ["Airport pickup", "Hotel check-in", "Welcome briefing"], images: ["https://images.unsplash.com/photo-1436491865332-7a61a109cc05?q=80&w=400&auto=format&fit=crop","https://images.unsplash.com/photo-1566073771259-6a8506099945?q=80&w=400&auto=format&fit=crop","https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?q=80&w=400&auto=format&fit=crop"] },
    { day: 2, title: "City Highlights Tour", desc: `Full day guided tour of ${pkg.location}'s most iconic landmarks. Visit historical sites, cultural attractions, and vibrant markets. Lunch at a local restaurant included.`, highlights: ["Guided city tour", "Major landmarks", "Local lunch"], images: ["https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?q=80&w=400&auto=format&fit=crop","https://images.unsplash.com/photo-1515542622106-78bda8ba0e5b?q=80&w=400&auto=format&fit=crop","https://images.unsplash.com/photo-1552832230-c0197dd311b5?q=80&w=400&auto=format&fit=crop"] },
    { day: 3, title: "Adventure & Leisure", desc: "Morning adventure activity followed by afternoon at leisure. Optional excursions available. Evening cultural show or dinner experience.", highlights: ["Adventure activity", "Free time", "Cultural experience"], images: ["https://images.unsplash.com/photo-1530521954074-e64f6810b32d?q=80&w=400&auto=format&fit=crop","https://images.unsplash.com/photo-1501555088652-021faa106b9b?q=80&w=400&auto=format&fit=crop","https://images.unsplash.com/photo-1506905925346-21bda4d32df4?q=80&w=400&auto=format&fit=crop"] },
    { day: 4, title: "Departure", desc: "Enjoy breakfast at the hotel. Check-out and transfer to airport for your departure flight. Take home wonderful memories!", highlights: ["Breakfast", "Hotel checkout", "Airport transfer"], images: ["https://images.unsplash.com/photo-1436491865332-7a61a109cc05?q=80&w=400&auto=format&fit=crop","https://images.unsplash.com/photo-1559827260-dc66d52bef19?q=80&w=400&auto=format&fit=crop","https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?q=80&w=400&auto=format&fit=crop"] },
  ];
  ...
  const optionalTours = [
    { id: 1, title: `${pkg.location} City Tour w/ Lunch`, tag: "Mandatory", desc: `Explore the cultural and historical richness of ${pkg.location} with a comprehensive full-day tour guided by a private expert. Discover iconic landmarks, hidden gems, and vibrant local markets while savoring authentic cuisine.`, adult: 349, single: 349, child611: 299, child25: 299, infant: 199, images: ["https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?q=80&w=400&auto=format&fit=crop","https://images.unsplash.com/photo-1515542622106-78bda8ba0e5b?q=80&w=400&auto=format&fit=crop","https://images.unsplash.com/photo-1552832230-c0197dd311b5?q=80&w=400&auto=format&fit=crop"] },
    { id: 2, title: "Desert Safari w/ Dinner", tag: "Optional", desc: "Embark on a thrilling desert adventure with dune bashing, camel riding, sandboarding and a traditional dinner under the stars. A private guide ensures a personal and memorable experience throughout the evening.", adult: 349, single: 349, child611: 299, child25: 299, infant: 199, images: ["https://images.unsplash.com/photo-1509316785289-025f5b846b35?q=80&w=400&auto=format&fit=crop","https://images.unsplash.com/photo-1506905925346-21bda4d32df4?q=80&w=400&auto=format&fit=crop","https://images.unsplash.com/photo-1530521954074-e64f6810b32d?q=80&w=400&auto=format&fit=crop"] },
    { id: 3, title: "Sunset Dhow Cruise", tag: "Optional", desc: "Sail on a traditional wooden dhow as the sun sets over the horizon. Enjoy live entertainment, unlimited beverages, and a delicious buffet dinner while taking in spectacular waterfront views.", adult: 249, single: 249, child611: 199, child25: 149, infant: 0, images: ["https://images.unsplash.com/photo-1602174423520-daa2d87175a0?q=80&w=400&auto=format&fit=crop","https://images.unsplash.com/photo-1543857778-c4a1a3e0b2eb?q=80&w=400&auto=format&fit=crop","https://images.unsplash.com/photo-1501555088652-021faa106b9b?q=80&w=400&auto=format&fit=crop"] },
  ];

  const hotels = [
    { name: "Grand Hyatt", nights: "3 Nights", room: "Deluxe King Room", stars: 5, image: "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?q=80&w=600&auto=format&fit=crop", checkIn: "08 Aug 2026", checkOut: "11 Aug 2026", amenities: [{ icon: Wifi, label: "Free WiFi" }, { icon: Coffee, label: "Breakfast" }, { icon: Car, label: "Transfers" }, { icon: Sparkles, label: "Spa" }], badge: "Luxury Pick", badgeColor: "bg-amber-500" },
    { name: "Hilton Garden Inn", nights: "1 Night", room: "Superior Twin Room", stars: 4, image: "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?q=80&w=600&auto=format&fit=crop", checkIn: "11 Aug 2026", checkOut: "12 Aug 2026", amenities: [{ icon: Wifi, label: "Free WiFi" }, { icon: Utensils, label: "Restaurant" }, { icon: MapPin, label: "City Centre" }], badge: "City Centre", badgeColor: "bg-teal-600" },
  ];
