...
function buildSharedData(pkg: any) {
  ...
  const optionalTours = [
    ...
    { id: 3, title: "Sunset Dhow Cruise", tag: "Optional", desc: "Sail on a traditional wooden dhow as the sun sets over the horizon. Enjoy live entertainment, unlimited beverages, and a delicious buffet dinner while taking in spectacular waterfront views.", adult: 249, single: 249, child611: 199, child25: 149, infant: 0, images: ["https://images.unsplash.com/photo-1569931728440-1488c2cfd34b?q=80&w=400&auto=format&fit=crop","https://images.unsplash.com/photo-1543857778-c4a1a3e0b2eb?q=80&w=400&auto=format&fit=crop","https://images.unsplash.com/photo-1501555088652-021faa106b9b?q=80&w=400&auto=format&fit=crop"] },
  ];
