...
export function ContactClient() {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground selection:bg-emerald-500/20">
            ...
            <section className="relative h-[45vh] min-h-[400px] w-full overflow-hidden flex items-center justify-center">
                ...
                <div className="relative z-10 container mx-auto px-4 text-center max-w-4xl pt-24 md:pt-28">
                    ...
                    <motion.h1
                        ...
                        className="text-4xl md:text-6xl font-black text-white tracking-tight drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)]"
                    >
