...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "listingPages.holidays" });
  return buildMetadata({ locale, path: "/holiday-packages", title: t("title"), description: t("subtitle") });
}
